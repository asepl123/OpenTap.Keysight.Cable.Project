...
namespace OpenTap.Keysight.Cable.Project.Teststeps
{
    ...
    public class MarkerSetup2 : TestStep
    {
        #region Settings
        ...
        public override void Run()
        {
            ...
            for (int i = 0; i < MarkerNumber; i++)
            {
                ...
                MyInst.ScpiCommand("DISP:WINDow:STAT 1");
                MyInst.ScpiCommand("DISPlay:WINDow:TRACe{0}:FEED '{1}'", (int)activeParameters[i] + 1, activeMarkerMeasurement);
                ...
                MyInst.ScpiCommand("DISPlay:WINDow:TABLe 1");

                string y_val = MyInst.ScpiQuery<System.String>(Scpi.Format(":CALCulate:MARKer{0}:Y?", i + 1), true);

                //Processing Marker Value
                activeAmplitude.Add(Convert.ToDouble(y_val.Split(',')[0]));
            }
